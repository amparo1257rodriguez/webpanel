// Archivo de configuración para personalizar la web
// Cambia los valores según el cliente
window.WEBPANEL_CONFIG = {
  ...
  colorFondo: "#00a6ffff", // Color de fondo principal
  colorDetalle: "#dd27acb7", // Color para detalles y banner
